...
//
//        JPanel laneSizePanel = new JPanel();
//        laneSizePanel.setLayout(new GridLayout(6, 6));
//        laneSizePanel.setBorder(new TitledBorder("Lane Size"));
//        lane_size_field = new TextField();
//        lane_size_field.setBounds(50,50,150,20);
//        laneSizePanel.add(lane_size_field);
//
//        JPanel MaxPatronPanel = new JPanel();
//        MaxPatronPanel.setLayout(new GridLayout(6, 6));
//        MaxPatronPanel.setBorder(new TitledBorder("Max Patron Count"));
//        max_patron_field = new TextField();
//        max_patron_field.setBounds(50,50,150,20);
//        MaxPatronPanel.add(max_patron_field);
//
//        OK=new Button("enter");
//        OK.setBounds(50,200,50,50);
//        OK.addActionListener(this);
//        Help = new Button("How To play");
//        Help.setBounds(100,200,160,50);
//        Help.addActionListener(this);
//
//        buttons_panel = new JPanel();
//        buttons_panel.setLayout(new GridLayout(6, 6));
//        buttons_panel.setBorder(new TitledBorder("buttons_panel"));
//        buttons_panel.add(OK);
//        buttons_panel.add(Help);
//
//        colPanel.add(laneSizePanel, "North");
//        colPanel.add(MaxPatronPanel, "Center");
//        colPanel.add(buttons_panel, "South");
//
